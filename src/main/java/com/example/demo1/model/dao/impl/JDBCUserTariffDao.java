...
import com.example.demo1.model.dao.mapper.UserTariffMapper;
...
//            if (Objects.nonNull(userTariff)) {
//                userTariffMapper.makeUnique(userTariffs, userTariff);
//            }
            rs.close();
            return userTariff;
        } catch (SQLException e) {
     ...
     */
    @Override
    public List<UserTariff> findTariffsByUserIdAndService(Integer id, String service) {
    ...
    @Override
    public List<UserTariff> findTariffsByUserId(Integer id) {
     ...
     */
    @Override
    public List<UserTariff> findUsersByTariffId(Integer id) {
    ...
    @Override
    public List<UserTariff> findServicesByUserId(Integer id) {
